...
const ExclusiveOffer = () => {
  return (
    <div className='flex flex-col items-center px-16 md:px-16 lg:px-24 xl:px-32 pt-20 pb:30'>
      <div className='flex flex-col md:flex-row items-center justify-between w-full'>
        <Title align="left" title="Exclusive Offers" subTitle="Unlock limited-time deals and exclusive packages designed to elevate your stay and create lasting memories." />
